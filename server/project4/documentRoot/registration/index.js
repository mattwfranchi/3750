...
const validate = () =>{
	...
	const confirmPasswordNode = document.getElementById("confirm_password");
...
const onUsernameChange = function(){
	...
	//TODO: complete the above
	// get username from document id username
	const username = document.getElementById("username").value;
	
	// send specified get request with axios, response promise
